package HW_L9_T1_GreetingServlet.servlets;
...
public class GreetingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String firstname = "Агеева";
        String lastname = "Ольга";
        String midlename = "Павловна";
        String phone = "89204785541";
        String interests = "Java";
        String uri = "https://github.com/ageeva-olga/HomeworkJava";
